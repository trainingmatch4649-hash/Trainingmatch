      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="relative rounded-2xl overflow-hidden mb-8 shadow-2xl bg-white">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
            ...
            {event.year && <p className="text-xl">{event.year}</p>}
          </div>
        </div>
        ...
        <div className="sticky bottom-6 z-40">
          <div className="bg-blue-950 rounded-2xl p-6 flex flex-col md:flex-row justify-between items-center gap-4">
